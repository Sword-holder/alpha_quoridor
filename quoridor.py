...
class Quoridor(object):
    ...
    def _move(self, forward):
        ...
        '''
        self._p1_loc += self.MOVE_STEP[forward]
    ...
    def alter(self):
        ...
        self._p1_loc, self._p2_loc = self._p2_loc, self._p1_loc
        for i in range(self.WALLS_SIZE):
            self._walls[i], self._walls[self.WALLS_SIZE - i - 1] = self._walls[self.WALLS_SIZE - i - 1], self._walls[i]
